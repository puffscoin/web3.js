...
abstractSocketProvider.subscribe('puffs_subscribe', 'logs', []);

// $ExpectType Promise<boolean>
abstractSocketProvider.unsubscribe('subId', 'puffs_unsubscribe');

// $ExpectType Promise<boolean>
abstractSocketProvider.clearSubscriptions('puffs_unsubscribe');
