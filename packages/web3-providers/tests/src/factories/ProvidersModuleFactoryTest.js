...
describe('ProvidersModuleFactoryTest', () => {
    ...
    it('createPuffscoinProvider returns instance of PuffscoinProvider', () => {
        expect(providersModuleFactory.createWeb3PuffscoinProvider({})).toBeInstanceOf(Web3PuffscoinProvider);
    });
});
