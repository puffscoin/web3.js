...
describe('GetTransactionFromBlockMethodTest', () => {
    ...
    it('constructor check', () => {
        expect(getTransactionFromBlockMethod.rpcMethod).toEqual('puffs_getTransactionByBlockNumberAndIndex');
    });
    ...
    it('calls execute with hash', () => {
        ...
        expect(getTransactionFromBlockMethod.rpcMethod).toEqual('puffs_getTransactionByBlockHashAndIndex');
    });
