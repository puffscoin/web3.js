...
The ``web3.puffs.Contract`` object makes it easy to interact with smart contracts on the PUFFScoin blockchain.
...
.. code-block:: javascript
    ...
    new web3.puffs.Contract(jsonInterface, address, options)
...
.. code-block:: javascript
    ...
    const myContract = new web3.puffs.Contract([...], '0xde0B295669a9FD93d5F28D9Ec85E40f4cb697BAe', {
...
.. code-block:: javascript
    ...
    const contract1 = new puffs.Contract(abi, address, {gasPrice: '12345678', defaultAccount: fromAddress});
...
.. code-block:: javascript
    ...
    // web3.js
    const MyContract = new web3.puffs.Contract(abi, address);
