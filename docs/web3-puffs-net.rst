...
.. code-block:: javascript
    ...
    web3.puffs.net.getNetworkType([callback])

Guesses the chain the node is connected by comparing the genesis hashes.

.. note:: It's recommended to use the :ref:`web3.puffs.getChainId <puffs-chainId>` method to detect the currently connected chain.
...
.. code-block:: javascript
    ...
    web3.puffs.net.getNetworkType().then(console.log);
    > "main"
