...
Source: `AbstractMethodFactory <https://github.com/puffscoin/web3.js/tree/1.0/packages/web3-core-method/lib/factories/AbstractMethodFactory.js>`_
...
Source: `AbstractMethod <https://github.com/puffscoin/web3.js/tree/1.0/packages/web3-core-method/lib/methods/AbstractMethod.js>`_

Because we are always adding new JSON-RPC methods do we just link the methods folder as resource.

Source: `Methods <https://github.com/puffscoin/web3.js/tree/1.0/packages/web3-core-method/src/methods/>`_
...
Source: `AbstractObservedTransactionMethod <https://github.com/puffscoin/web3.js/tree/1.0/packages/web3-core-method/lib/methods/transaction/AbstractObservedTransactionMethod.js>`_
