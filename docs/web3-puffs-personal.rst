...
The ``web3-puffs-personal`` package allows you to interact with the PUFFScoin node's accounts.
...
.. code-block:: javascript
    ...
    web3.puffs.personal.newAccount(password, [callback])
...
:ref:`web3.puffs.accounts.create() <accounts-create>` where the key pair is
...
.. code-block:: javascript
    ...
    web3.puffs.personal.newAccount('!@superpassword')
    .then(console.log);
...
.. code-block:: javascript
    ...
    web3.puffs.personal.sign(dataToSign, address, password [, callback])
...
.. code-block:: javascript
    ...
    web3.puffs.personal.sign("Hello world", "0x11f4d0A3c12e86B4b5F39B213F7E19D048276DAe", "test password!")
    .then(console.log);
    > "0x30755ed65396facf86c53e6217c52b4daebe72aa4941d89635409de4c9c7f9466d4e9aaec7977f05e923889b33c0d0dd27d7226b6e6f56ce737465c5cfd04be400"

    // the below is the same
    web3.puffs.personal.sign(web3.utils.utf8ToHex("Hello world"), "0x11f4d0A3c12e86B4b5F39B213F7E19D048276DAe", "test password!")
    .then(console.log);
    > "0x30755ed65396facf86c53e6217c52b4daebe72aa4941d89635409de4c9c7f9466d4e9aaec7977f05e923889b33c0d0dd27d7226b6e6f56ce737465c5cfd04be400"
...
.. code-block:: javascript
    ...
    web3.puffs.personal.ecRecover(dataThatWasSigned, signature [, callback])
...
.. code-block:: javascript
    ...
    web3.puffs.personal.ecRecover("Hello world", "0x30755ed65396facf86c53e6217c52b4daebe72aa4941d89635409de4c9c7f9466d4e9aaec7977f05e923889b33c0d0dd27d7226b6e6f56ce737465c5cfd04be400").then(console.log);
...
.. code-block:: javascript
    ...
    web3.puffs.personal.signTransaction(transaction, password [, callback])
...
.. code-block:: javascript
    ...
    web3.puffs.personal.sendTransaction(transactionOptions, password [, callback])
...
.. code-block:: javascript
    ...
    web3.puffs.personal.unlockAccount(address, password, unlockDuraction [, callback])
...
.. code-block:: javascript
    ...
    web3.puffs.personal.unlockAccount("0x11f4d0A3c12e86B4b5F39B213F7E19D048276DAe", "test password!", 600)
...
.. code-block:: javascript
    ...
    web3.puffs.personal.lockAccount(address [, callback])
...
.. code-block:: javascript
    ...
    web3.puffs.personal.lockAccount("0x11f4d0A3c12e86B4b5F39B213F7E19D048276DAe")
...
.. code-block:: javascript
    ...
    web3.puffs.personal.getAccounts([callback])

Returns a list of accounts the node controls by using the provider and calling
the RPC method ``personal_listAccounts``. Using :ref:`web3.puffs.accounts.create() <accounts-create>`
will not add accounts into this list. For that use
:ref:`web3.puffs.personal.newAccount() <personal-newaccount>`.

The results are the same as :ref:`web3.puffs.getAccounts() <puffs-getaccounts>` except that calls
the RPC method ``puffs_accounts``.
...
.. code-block:: javascript
    ...
    web3.puffs.personal.getAccounts()
    .then(console.log);
...
.. code-block:: javascript
    ...
    web3.puffs.personal.importRawKey(privateKey, password)
...
.. code-block:: javascript
    ...
    web3.puffs.personal.importRawKey("cd3376bb711cb332ee3fb2ca04c6a8b9f70c316fcdf7a1f44ef4c7999483295e", "password1234")
    .then(console.log);
